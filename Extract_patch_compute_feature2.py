...
extract_patch ('/home/ulaval.ca/lesee/projects/def-veman3/ul-val-prj-criucpq-poc/Oncotech-WSI/WSIs/WSIs2')
...
patches_dir = '/home/ulaval.ca/lesee/projects/def-veman3/ul-val-prj-criucpq-poc/Oncotech-WSI/Project_2/Patches/Patch2'
...
all_features_df_scale_50_2 = pd.concat(df_list1, ignore_index=True)

folder_path = "/home/ulaval.ca/lesee/projects/def-veman3/ul-val-prj-criucpq-poc/Oncotech-WSI/Project_2"
file_name = "all_features_df_scale_50_2.csv"
full_path = os.path.join(folder_path, file_name)
# Save the DataFrame to a csv file
all_features_df_scale_50_2.to_csv(full_path, index=False)
